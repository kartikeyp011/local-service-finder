...
<head>
    <meta charset="utf-8">
    <title>LocalServiceFinder - Find Trusted Local Professionals</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="" name="keywords">
    <meta name="description" content="LocalServiceFinder connects you with trusted electricians, plumbers, cleaners, and more in your local area. Find reliable help fast.">
        ...
        <nav id="mainNavbar" class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    ...
                    <a href="login.php" class="btn btn-primary rounded-0 py-4 px-lg-5 d-none d-lg-block">
                        Login / Signup<i class="fa fa-arrow-right ms-3"></i>
                    </a>
            </div>
        </nav>
        <!-- Navbar End -->
